...
#---------------------------------------------------------------------------------
# list of directories containing libraries, this must be containing 
# include and source
#---------------------------------------------------------------------------------
LIBADDDIRS	:= libs/LibACNH/

#---------------------------------------------------------------------------------
# list of modulefolders containing helperfiles
#---------------------------------------------------------------------------------
HELPERMODULES	:= debugger dmnt file
HELPERDIR		:= source/helpers/
...
SOURCES 	:= 	source \
				...
				$(foreach module,$(HELPERMODULES),$(HELPERDIR)/$(module)) \
                nanovg/shaders
DATA		:=	data
...
export INCLUDE	:=	$(foreach dir,$(INCLUDES),-I$(CURDIR)/$(dir)) \
					...
					-I$(CURDIR)/nanovg/include/nanovg \
					-I$(CURDIR)/$(BUILD)
